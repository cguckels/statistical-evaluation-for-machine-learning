...
public class RStatsTester{
	...
	public void testFriedman(){
		...
		/*
		 * Example from: Japkowicz/Shah (2011), Evaluating Learning Algorithms. Pages 255 ff.
		 * Individual performance results of different classifiers (rows) over different domains (columns)
		 */
	...
	public void testNemenyi2(){
		...
		/*
		 * Example from: Zar, J. H. (2010), Biostatistical Analysis, Pages 216, 241.
		 * Distribution of flies (rows) in three different vegetation layers (columns)
		 */
	...
	public void testMcNemar(){
		...
		/*
		 * Example from: Japkowicz/Shah (2011), Evaluating Learning Algorithms. Pages 226 ff.
		 */
	...
	public void testKruskalWallis(){
		...
		/*
		 * Example from: Hollander & Wolfe (1973), 116.
		...
		double[] sampleB = {3.8, 2.7, 4.0, 2.4, Double.NaN};  // with obstructive airway disease
	...
	public void testWilcoxonSignedRank(){
		...
		/*
		 * Example from: Field/Miles/Field (2012), 655ff.
		 * (Made up) depressant effects of ecstasy consumed on different days
		 */
		
		double[] sampleA  = {15,35,16,18,19,17,27,16,13,20}; //on a sunday
		double[] sampleB = {28,35,35,24,39,32,27,29,36,35}; //on a monday
	...
	public void testMannWhitneyU(){
		...
		/*
		 * Example from: Field/Miles/Field (2012), 655ff.
		 * (Made up) depressant effects of recreational drugs (ecstasy/alcohol)
		 */
	...
	public void testDependentT(){
		...
		/*
		 * Example from: Field/Miles/Field (2012), p. 389 ff.
		 * (Made up) anxiety raised by real and pictures of spiders
		 */
	...
	public void testRepeatedMeasuresOneWayANOVA(){
		...
		/*
		 * Example from: Field/Miles/Field (2012), p. 563 ff.
		 * (Made up) time to retch after consuming different food types
		 */
	...
	public void testAdjustP(){
		...
		/*
		 * Analogous to testPairwiseT, but result is used to test p-value correction with bonferroni adjustment
		 * Example from: Field/Miles/Field (2012), p. 563 ff.
		 * (Made up) time to retch after consuming different food types
		 */
