...
public class StatisticalEvaluationData {
	 ...
	 */
	public StatisticalEvaluationData(int[][] contingencyMatrix, HashMap<String, ArrayList<ArrayList<Double>>> samples, HashMap<String, ArrayList<Double>> samplesAverage, List<Pair<String, String>> datasetNames,
			ArrayList<Pair<String, String>> modelMetadata, ReportTypes pipelineType, int nFolds, int nRepetitions, boolean isBaselineEvaluation) {
